...
pulitzer <- mutate(pulitzer, Pulitzer.Prize.Change = Pulitzer.Prize.Winners.and.Finalists..1990.2003 - Pulitzer.Prize.Winners.and.Finalists..2004.2014)
